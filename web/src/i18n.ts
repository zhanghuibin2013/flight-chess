...
const ZH: Dict = {
  ...
  'admin.tabManual':          '手工录入',
  'admin.tabImage':           '图片识别',
  'admin.kindLabel':          '题型',
  'admin.pendingList':        '待保存题目',
  'admin.saveAll':            '全部保存到题库',
  'admin.addToPending':       '添加到待保存列表',
  'admin.addedToPending':     '✓ 已添加到待保存列表',
  'admin.noPending':          '没有待保存的题目',
  'admin.pendingSave':        '有 {n} 道新增题目未保存，请点击「保存」写入题库',
  'admin.pullDown':           '↓ 下拉刷新',
  ...
  'admin.ir.collapse':        '收起',
  'admin.ir.expand':          '展开',
  'admin.ir.uploadHint':      '点击选择图片或拖放到此处',
  'admin.ir.formats':         '支持 JPG / PNG / WebP，最大 8MB',
  'admin.ir.recognize':       '开始识别',
  'admin.ir.recognizing':     '识别中…',
  'admin.ir.clear':           '清空',
  'admin.ir.reselect':        '重新选择',
  'admin.ir.addToBank':       '✓ 加入题库',
  'admin.ir.discard':         '× 放弃',
  'admin.ir.noResult':        '未识别到题目',
  'admin.ir.recognizedCount': '识别到 {n} 道题目',
  'admin.ir.addedCount':      '已加入 {n} 道题目到列表顶部',
  'admin.ir.addedNeedSave':   '✓ 已添加 {n} 道题到列表 — 请点击右上角「保存」写入题库文件',
  'admin.ir.addedToPendingCount': '✓ 已添加 {n} 道题到待保存列表 — 请在下方检查后点击「全部保存到题库」',
  'admin.ir.settings':        '⚙ AI 设置',
  'admin.ir.provider':        '接口协议',
  'admin.ir.provider.openai': 'OpenAI 兼容',
  'admin.ir.provider.anthropic': 'Anthropic Claude',
  'admin.ir.baseUrl':         'Base URL',
  'admin.ir.apiKey':          'API Key',
  'admin.ir.apiKeyPlaceholder':'输入 API Key…',
  'admin.ir.model':           '模型',
  'admin.ir.saveSettings':    '保存设置',
  'admin.ir.settingsSaved':   '设置已保存',
  'admin.ir.err.noImage':     '请先选择图片',
  'admin.ir.err.noApiKey':    '请先在 AI 设置中配置 API Key',
  ...
  'game.confirmMove':       '确认出子',
  'game.confirmTakeoff':    '确认起飞',
  'game.cancel':            '取消',
  'game.arsenal':           '我的装备',
  'game.radars':            '📡 雷达：',
...
const EN: Dict = {
  ...
  'admin.tabImage':           'Image Recognition',
  'admin.kindLabel':          'Kind',
  'admin.pendingList':        'Pending Questions',
  'admin.saveAll':            'Save All to Bank',
  'admin.addToPending':       'Add to Pending List',
  'admin.addedToPending':     '✓ Added to pending list',
  'admin.noPending':          'No pending questions',
  'admin.pendingSave':        '{n} new question(s) unsaved — click "Save" to write to the bank',
  'admin.pullDown':           '↓ Pull down to refresh',
  ...
  'admin.ir.collapse':        'Collapse',
  'admin.ir.expand':          'Expand',
  'admin.ir.uploadHint':      'Click to select or drag & drop an image',
  'admin.ir.formats':         'JPG / PNG / WebP, max 8 MB',
  'admin.ir.recognize':       'Recognize',
  'admin.ir.recognizing':     'Recognizing…',
  'admin.ir.clear':           'Clear',
  'admin.ir.reselect':        'Reselect',
  'admin.ir.addToBank':       '✓ Add to Bank',
  'admin.ir.discard':         '× Discard',
  'admin.ir.noResult':        'No questions recognized',
  'admin.ir.recognizedCount': 'Recognized {n} question(s)',
  'admin.ir.addedCount':      'Added {n} question(s) to the top of the list',
  'admin.ir.addedNeedSave':   '✓ Added {n} question(s) — click "Save" (top right) to write to the question bank file',
  'admin.ir.addedToPendingCount': '✓ Added {n} question(s) to pending list — review below then click "Save All to Bank"',
  'admin.ir.settings':        '⚙ AI Settings',
  'admin.ir.provider':        'API Protocol',
  'admin.ir.provider.openai': 'OpenAI Compatible',
  'admin.ir.provider.anthropic': 'Anthropic Claude',
  'admin.ir.baseUrl':         'Base URL',
  'admin.ir.apiKey':          'API Key',
  'admin.ir.apiKeyPlaceholder':'Enter API Key…',
  'admin.ir.model':           'Model',
  'admin.ir.saveSettings':    'Save Settings',
  'admin.ir.settingsSaved':   'Settings saved',
  'admin.ir.err.noImage':     'Please select an image first',
  'admin.ir.err.noApiKey':    'Please configure the API Key in AI Settings',
  ...
  'game.confirmTakeoff':    'Confirm Takeoff',
  'game.cancel':            'Cancel',
